...
#define SVF_DAMAGEABLE			0x00000008	// from q2
#define SVF_TRIGGER_CAMOWNER	0x00000010	// from q2
#define SVF_MUD					0x00000020	// from q2
#define	SVF_GIB					0x00000040	// from q2 Knightmare- gib flag
...
// Filesytem data types					 // from q2
#ifdef GAME_INCLUDE						 // from q2
typedef int fileHandle_t;				 // from q2
										 // from q2
typedef enum							 // from q2
{										 // from q2
	FS_READ,							 // from q2
	FS_WRITE,							 // from q2
	FS_APPEND							 // from q2
} fsMode_t;								 // from q2
#endif // GAME_INCLUDE					 // from q2
