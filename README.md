...
- new cvar "gamemod" this displays the current running mode of the server, the current mod loaded.
...
- assault mod - process_assault_ini_file();
- blood money mod v616 - process_bloodmoney_ini_file();
- botmatch mod v0.39 - process_botmatch_ini_file();    
- botmen - process_botmen_ini_file();
- monkey mod 2.0c - process_comp_ini_file();
- coop mod - process_coop_ini_file();    
- curse mod - process_curse_ini_file();
- dog mod - process_dogmod_ini_file();
- genocide mod - process_genocide_ini_file();
- godfather mod - process_godfather_ini_file();
- gunrace mod - process_gunrace_ini_file();
- hitmen mod - process_hitmen_ini_file();
- hitmen teams mod - process_hitmen_teams_ini_file();
- insanity mod - process_insanity_ini_file();
- insomnia mod - process_insomnia_ini_file();
- kpq2 mod - process_kpq2_ini_file();
- kpz mod - process_kpz_ini_file();
- sgm mod - process_sqm_ini_file();
